package com.myRecipe.myRecipe_backend.domain.inventory.application.service;

import com.myRecipe.myRecipe_backend.domain.inventory.application.dto.request.InventoryRequest;
import com.myRecipe.myRecipe_backend.domain.inventory.application.mapper.InventoryMapper;
import com.myRecipe.myRecipe_backend.domain.inventory.domain.entity.Inventory;
import com.myRecipe.myRecipe_backend.domain.inventory.domain.service.InventorySaveService;
